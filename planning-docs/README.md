...
**Version**: **5.0.0** — released 2026-09-09 via `./container-manager.sh major` (AUTO_MODE). Tag `v5.0.0` on `main` at `5c4b282`; GitHub release [v5.0.0](https://github.com/sevakavakians/kato/releases/tag/v5.0.0); images `ghcr.io/sevakavakians/kato:5.0.0`/`:5.0`/`:5`/`:latest` (same digest). Major bump because the `anomalies`→`fuzzy_matches` prediction-field split (DECISION-019) is a breaking API change. See DECISION-022 in `DECISIONS.md` and `completed/features/2026-09-09-kato-v5.0.0-release.md`.
