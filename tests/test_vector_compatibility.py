...
from kato.searches.vector_searches import CVCSearcher, calculate_diff_lengths
...
class TestVectorDatabaseIntegration:
    ...
    def test_vector_search_engine_basic(self):
        ...
        # Create engine with MongoDB backend (for testing without external services)
        ...
        assert engine.config.backend == "mongodb"
    ...
    def test_configuration_system(self):
        ...
        # Test configuration with different backend
