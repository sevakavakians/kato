"""
Test Redis-based session storage for KATO v2.0
...
from kato.v2.sessions.session_manager import SessionState
from kato.v2.sessions.redis_session_store import RedisSessionStore
from kato.v2.sessions.session_manager_redis import RedisSessionManager
...
class TestRedisSessionManager:
    ...
    @patch('kato.v2.sessions.session_manager_redis.get_redis_session_store')
